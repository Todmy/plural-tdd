describe('MovieCore', function() {
  ...
  it('should create popular movie', function() {
    ...
    var expectedData = function(data) {
       return angular.fromJson(data).movieId === objectForPost.movieId;
    };

    $httpBackend.expectPOST(/./, expectedData)
      .respond(201);

    var popularMovie = new PopularMovies(objectForPost);
  ...
  it('should authenticate requests', function() {
    ...
    //   return angular.fromJson(headers).authToken === 'todmy';
    // };
    var headerData = function(headers) {
      return headers.authToken === 'todmy';
    };

    var matchAny = /.*/;

    $httpBackend.expectGET(matchAny, headerData)
      .respond(200);
